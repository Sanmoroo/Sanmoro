...
#pragma endregion
    ...
    {
        Setting<bool>  UseHeadTracking { true, Range<bool>(false, true) };
        Setting<bool>  HeadTrackingAutoReset{ true, Range<bool>(false, true) };
        Setting<float> HeadRotationResponsiveness{ 1.0f, Range<float>(0.0f, 1.0f) };

        Setting<float> GazeResponsiveness { 0.5f, Range<float>(0.0f, 1.0f) };
        Setting<float> GazeYawLimitDegrees { 13.5f, Range<float>(0.0f, 180.0f) };
        Setting<float> GazePitchUpLimitDegrees { 10.5f, Range<float>(0.0f, 90.0f) };
        Setting<float> GazePitchDownLimitDegrees { -6.0f, Range<float>(-90.0f, 0.0f) };

        AxisSettings HeadYawRightDegrees{   { 76.5f, Range<float>(0.0f, 180.0f)},       // Limit
                                            { 1.0f, Range<float>(0.0f, 5.0f)},          // SensitivityScaling
                                            { 0.0625f, Range<float>(0.0f, 1.0f)},       // SCurveStrengthNorm
                                            { 0.5f, Range<float>(0.0f, 1.0f)},          // SCurveMidPointNorm
                                            { 0.0f, Range<float>(0.0f, 1.0f)} };        // DeadZoneNorm
      
        AxisSettings HeadYawLeftDegrees{    { -76.5f, Range<float>(-180.0f, 0.0f)},     // Limit
                                            { 1.0f, Range<float>(0.0f, 5.0f)},          // SensitivityScaling
                                            { 0.0625f, Range<float>(0.0f, 1.0f)},       // SCurveStrengthNorm
                                            { 0.5f, Range<float>(0.0f, 1.0f)},          // SCurveMidPointNorm
                                            { 0.0f, Range<float>(0.0f, 1.0f)} };        // DeadZoneNorm
      
        AxisSettings HeadPitchUpDegrees{    { 59.5f, Range<float>(0.0f, 90.0f)},        // Limit
                                            { 1.0f, Range<float>(0.0f, 5.0f)},          // SensitivityScaling
                                            { 0.0625f, Range<float>(0.0f, 1.0f)},       // SCurveStrengthNorm
                                            { 0.5f, Range<float>(0.0f, 1.0f)},          // SCurveMidPointNorm
                                            { 0.0f, Range<float>(0.0f, 1.0f)} };        // DeadZoneNorm
      
        AxisSettings HeadPitchDownDegrees{  { -34.0f, Range<float>(-90.0f, 0.0f)},      // Limit
                                            { 1.0f, Range<float>(0.0f, 5.0f)},          // SensitivityScaling
                                            { 0.0625f, Range<float>(0.0f, 1.0f)},       // SCurveStrengthNorm
                                            { 0.5f, Range<float>(0.0f, 1.0f)},          // SCurveMidPointNorm
                                            { 0.0f, Range<float>(0.0f, 1.0f)} };        // DeadZoneNorm
      
        AxisSettings HeadRollRightDegrees{  { 76.5f, Range<float>(0.0f, 90.0f)},        // Limit
                                            { 1.0f, Range<float>(0.0f, 5.0f)},          // SensitivityScaling
                                            { 0.0625f, Range<float>(0.0f, 1.0f)},       // SCurveStrengthNorm
                                            { 0.5f, Range<float>(0.0f, 1.0f)},          // SCurveMidPointNorm
                                            { 0.0f, Range<float>(0.0f, 1.0f)} };        // DeadZoneNorm
          
        AxisSettings HeadRollLeftDegrees{   { -76.5f, Range<float>(-90.0f, 0.0f)},      // Limit
                                            { 1.0f, Range<float>(0.0f, 5.0f)},          // SensitivityScaling
                                            { 0.0625f, Range<float>(0.0f, 1.0f)},       // SCurveStrengthNorm
                                            { 0.5f, Range<float>(0.0f, 1.0f)},          // SCurveMidPointNorm
                                            { 0.0f, Range<float>(0.0f, 1.0f)} };        // DeadZoneNorm

        AxisSettings HeadXRightMm{          { 300.0f, Range<float>(0.0f, 500.0f)},      // Limit
                                            { 1.0f, Range<float>(0.0f, 5.0f)},          // SensitivityScaling
                                            { 0.0f, Range<float>(0.0f, 1.0f)},          // SCurveStrengthNorm
                                            { 0.5f, Range<float>(0.0f, 1.0f)},          // SCurveMidPointNorm
                                            { 0.0f, Range<float>(0.0f, 1.0f)} };        // DeadZoneNorm
                                             
        AxisSettings HeadXLeftMm{           { -300.0f, Range<float>(-500.0f, 0.0f)},    // Limit
                                            { 1.0f, Range<float>(0.0f, 5.0f)},          // SensitivityScaling
                                            { 0.0f, Range<float>(0.0f, 1.0f)},          // SCurveStrengthNorm
                                            { 0.5f, Range<float>(0.0f, 1.0f)},          // SCurveMidPointNorm
                                            { 0.0f, Range<float>(0.0f, 1.0f)} };        // DeadZoneNorm
                                             
        AxisSettings HeadYUpMm{             { 300.0f, Range<float>(0.0f, 500.0f)},      // Limit
                                            { 1.0f, Range<float>(0.0f, 5.0f)},          // SensitivityScaling
                                            { 0.0f, Range<float>(0.0f, 1.0f)},          // SCurveStrengthNorm
                                            { 0.5f, Range<float>(0.0f, 1.0f)},          // SCurveMidPointNorm
                                            { 0.0f, Range<float>(0.0f, 1.0f)} };        // DeadZoneNorm
                                             
        AxisSettings HeadYDownMm{           { -300.0f, Range<float>(-500.0f, 0.0f)},    // Limit
                                            { 1.0f, Range<float>(0.0f, 5.0f)},          // SensitivityScaling
                                            { 0.0f, Range<float>(0.0f, 1.0f)},          // SCurveStrengthNorm
                                            { 0.5f, Range<float>(0.0f, 1.0f)},          // SCurveMidPointNorm
                                            { 0.0f, Range<float>(0.0f, 1.0f)} };        // DeadZoneNorm
                                             
        AxisSettings HeadZBackMm{           { 300.0f, Range<float>(0.0f, 500.0f)},      // Limit
                                            { 1.0f, Range<float>(0.0f, 5.0f)},          // SensitivityScaling
                                            { 0.0f, Range<float>(0.0f, 1.0f)},          // SCurveStrengthNorm
                                            { 0.5f, Range<float>(0.0f, 1.0f)},          // SCurveMidPointNorm
                                            { 0.0f, Range<float>(0.0f, 1.0f)} };        // DeadZoneNorm
                                             
        AxisSettings HeadZForwardMm{        { -300.0f, Range<float>(-500.0f, 0.0f)},    // Limit
                                            { 1.0f, Range<float>(0.0f, 5.0f)},          // SensitivityScaling
                                            { 0.0f, Range<float>(0.0f, 1.0f)},          // SCurveStrengthNorm
                                            { 0.5f, Range<float>(0.0f, 1.0f)},          // SCurveMidPointNorm
                                            { 0.0f, Range<float>(0.0f, 1.0f)} };        // DeadZoneNorm
        ...
        void SetHeadMultiAxisSettingsValues(AxisFlags axes, AxisDirectionFlags axisDirections, Setting<float> AxisSettings::* pAxisSettingsMember, float value, bool valueIsNormalizedOnRangeMagnitude);
        ...
        {
            SetHeadMultiAxisSettingsValues(AxisFlags::AllRotation, AxisDirectionFlags::Both, &AxisSettings::SensitivityScaling, sensitivityScaling, false);
        };
        ...
        void SetHeadAllRotationAxisSettingsLimitNormalized(float limitNormalizedOnRange)
        {
            SetHeadMultiAxisSettingsValues(AxisFlags::AllRotation, AxisDirectionFlags::Both, &AxisSettings::Limit, limitNormalizedOnRange, true);
        };
        ...
        {
            SetHeadMultiAxisSettingsValues(AxisFlags::AllPosition, AxisDirectionFlags::Both, &AxisSettings::SensitivityScaling, sensitivityScaling, false);
        };
        ...
        void SetHeadAllPositionAxisSettingsLimitNormalized(float limitNormalizedOnRange)
        {
            SetHeadMultiAxisSettingsValues(AxisFlags::AllPosition, AxisDirectionFlags::Both, &AxisSettings::Limit, limitNormalizedOnRange, true);
        };

        // Description:
        //      Sets the ratio between eye- and head tracking.
        //      This will change the distribution of the maximum gaze and head angles
        //
        // Parameters:
    ...
    struct TGI_TYPE_EXPORT BilateralFilterSettings
    {
        bool IsEnabled;
        ...
        // unit is mm on the display
        float sStart; // start of the falloff from the latest point. This should be about the 
                                    // expected jitter of the unfiltered point
        float sEnd; // end of the falloff from the latest point
    ...
    struct TGI_TYPE_EXPORT IStreamsProvider
    {
        ...
        virtual int GetUnfilteredGazePoints(const GazePoint*& gazePoints) = 0;
        virtual bool GetLatestUnfilteredGazePoint(GazePoint& gazePoint) = 0;
    ...
    struct TGI_TYPE_EXPORT IFilters
    {
        ...
        virtual void SetBilateralFilterSettings(BilateralFilterSettings settings) = 0;
        ...
        virtual void GetBilateralFilterGazePoint(GazePoint& gazePoint) const = 0;
    };
